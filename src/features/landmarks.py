    ...
    with py7zr.SevenZipFile(landmarks_path, mode='r') as archive:
        ...
        for i, name in enumerate(archive.getnames()):
            ...
            if name.endswith(".ljson"):
                ...
                sequences[i, :, :] = torch.transpose(data, 0, 1)
        shutil.rmtree('temp')
    return sequences
